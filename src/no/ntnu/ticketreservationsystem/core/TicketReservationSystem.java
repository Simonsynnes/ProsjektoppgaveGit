...
public class TicketReservationSystem {
    ...
    public String getListOfAllPersons() {
        String listString = "";
        for (Passenger person : getListOfPassengers()) {
    ...
    public List<Passenger> getListOfPassengers() {
        ...
        for (Passenger passenger : passengerRegister.getPassengerList()) {
            if (passenger.getOccupation().equals("passenger")) {
                list.add(passenger);
            }
        }
        return list;
    ...
    public List<Passenger> getListOfPilots() {
        List<Passenger> list = new ArrayList<>();
        for (Passenger pilot : passengerRegister.getPassengerList()) {
            if (pilot.getOccupation().equals("pilot")) {
                list.add(pilot);
            }
        }
        return list;
    ...
    public List<Passenger> getListOfCrew() {
        List<Passenger> list = new ArrayList<>();
        for (Passenger crew : passengerRegister.getPassengerList()) {
            if (crew.getOccupation().equals("crew")) {
                list.add(crew);
            }
        }
        return list;
